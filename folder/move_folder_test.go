...
func Test_folder_MoveFolder(t *testing.T) {
	...
	tests := [...]struct {
		...
		{
			name_of_test: "We move the folder to child of same level (reverse of last test)",
			name:         "delta",
			dst:          "bravo",
			folders:      GetTestingSampleData2(),
			want: []folder.Folder{
				...
				{Name: "delta", Paths: "alpha.bravo.delta", OrgId: orgID},
				{Name: "echo", Paths: "alpha.bravo.delta.echo", OrgId: orgID},
				{Name: "foxtrot", Paths: "foxtrot", OrgId: uuid.FromStringOrNil("c1556e17-b7c0-45a3-a6ae-9546248fb17a")},
				{Name: "golf", Paths: "golf", OrgId: orgID},
			},
			wantErr: nil,
		...
		{
			name_of_test: "We move the root (alpha) to golf",
			name:         "alpha",
			dst:          "golf",
			folders:      GetTestingSampleData2(),
			want: []folder.Folder{
				{Name: "alpha", Paths: "golf.alpha", OrgId: orgID},
				{Name: "bravo", Paths: "golf.alpha.bravo", OrgId: orgID},
				{Name: "charlie", Paths: "golf.alpha.bravo.charlie", OrgId: orgID},
				{Name: "delta", Paths: "golf.alpha.delta", OrgId: orgID},
				{Name: "echo", Paths: "golf.alpha.delta.echo", OrgId: orgID},
				{Name: "foxtrot", Paths: "foxtrot", OrgId: uuid.FromStringOrNil("c1556e17-b7c0-45a3-a6ae-9546248fb17a")},
				{Name: "golf", Paths: "golf", OrgId: orgID},
			},
			wantErr: nil,
		...
		{
			name_of_test: "We move the delta to charlie (this will make a linear line (a -> b -> c -> d -> e)",
			name:         "delta",
			dst:          "charlie",
			folders:      GetTestingSampleData2(),
			want: []folder.Folder{
				...
				{Name: "bravo", Paths: "alpha.bravo", OrgId: orgID},
				{Name: "charlie", Paths: "alpha.bravo.charlie", OrgId: orgID},
				{Name: "delta", Paths: "alpha.bravo.charlie.delta", OrgId: orgID},
				{Name: "echo", Paths: "alpha.bravo.charlie.delta.echo", OrgId: orgID},
				{Name: "foxtrot", Paths: "foxtrot", OrgId: uuid.FromStringOrNil("c1556e17-b7c0-45a3-a6ae-9546248fb17a")},
				{Name: "golf", Paths: "golf", OrgId: orgID},
			},
			wantErr: nil,
