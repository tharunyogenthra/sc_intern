...
// 		},
// 		{
// 			name_of_test:   "Gets all child folders a child folder",
// 			orgID:          orgID,
...
// 			name_of_folder: "echo",
// 			folders:        GetTestingSampleData(),
// 			want:           "Error: Folder does not exist",
// 		},
// 		{
// 			name_of_test:   "Given folder doesnt exist",
// 			orgID:          orgID,
// 			name_of_folder: "invalid_folder",
// 			folders:        GetTestingSampleData(),
// 			want:           "Error: Folder does not exist in the specified organization",
// 		},
// 	}
// 	for _, tt := range tests {
// 		t.Run(tt.name_of_test, func(t *testing.T) {
// 			f := folder.NewDriver(tt.folders)
// 			got := f.GetAllChildFolders(tt.orgID, tt.name_of_folder)
